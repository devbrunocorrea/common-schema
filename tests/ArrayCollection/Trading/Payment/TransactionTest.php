...
/**
 * @coversDefaultClass \Gpupo\CommonSchema\ArrayCollection\Trading\Payment\Transaction
 */
class TransactionTest extends AbstractTestCase
{
    /**
     * @return \Gpupo\CommonSchema\ArrayCollection\Trading\Payment\Transaction
     */
